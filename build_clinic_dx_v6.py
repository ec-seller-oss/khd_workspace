...
light_table(s, rows, Inches(0.45), Inches(1.8), Inches(12.43), Inches(4.9),
...
for i, (st, ti, sub, body, hi) in enumerate(steps):
    ...
    t(s, sub, cx, y0+Inches(0.54), cw, Inches(0.3), sz=11, col=RGBColor(0xF2,0xD8,0xD6), align=PP_ALIGN.CENTER)
    t(s, ti, cx+Inches(0.25), y0+Inches(1.05), cw-Inches(0.5), Inches(0.55), sz=17, bold=True, col=INK, align=PP_ALIGN.CENTER)
    t(s, body, cx+Inches(0.3), y0+Inches(1.65), cw-Inches(0.6), Inches(1.9), sz=11.5, col=GRY, line_sp=1.15)
    if hi:
        bx(s, cx+Inches(0.25), y0+Inches(3.2), cw-Inches(0.5), Inches(1.4), REDBG, line=RED, lw=1.5)
        t(s, hi[0], cx+Inches(0.25), y0+Inches(3.3), cw-Inches(0.5), Inches(0.3), sz=11, bold=True, col=RED, align=PP_ALIGN.CENTER)
        t(s, hi[1], cx+Inches(0.25), y0+Inches(3.6), cw-Inches(0.5), Inches(0.6), sz=26, bold=True, col=RED, align=PP_ALIGN.CENTER)
        t(s, hi[2], cx+Inches(0.3), y0+Inches(4.25), cw-Inches(0.6), Inches(0.4), sz=10, col=GRY, align=PP_ALIGN.CENTER, line_sp=1.0)
...
prs.save("clinic_dx_v6.pptx")
print("saved clinic_dx_v6.pptx  /  slides:", len(prs.slides._sldIdLst))

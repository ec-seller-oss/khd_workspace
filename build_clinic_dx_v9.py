...
v9: 新料金（成果報酬40%×6ヶ月→7ヶ月目〜月5万保守・月1MTG込み）＋削減効果グラフ3点を組込み。
出力: clinic_dx_v9.pptx
"""
...
_CH = "/Users/kikuchikenta/01_honbu_docs_automation"
CHART_RANGE   = _CH + "/_chart_range.png"
CHART_BREAK   = _CH + "/_chart_breakdown.png"
CHART_SAVINGS = _CH + "/_savings_chart.png"
W = Inches(13.33)
H = Inches(7.5)
...
offers = [("初期費用", "0円"), ("月額基本料", "0円"), ("成果報酬", "40%")]
...
t(s, "※成果報酬は最初の6ヶ月のみ。7ヶ月目以降は 月5万円の保守（月1回MTG・運用相談込み）",
  Inches(0.9), Inches(6.5), Inches(7.3), Inches(0.3), sz=10.5, bold=True, col=REDD)
...
light_table(s, rows, Inches(0.55), Inches(1.85), Inches(12.23), Inches(2.9),
            [Inches(2.0), Inches(3.85), Inches(4.05), Inches(2.33)], hi_col=3, sz=12, header_sz=12.5)
t(s, "削減効果の幅（公開事例ベース）", Inches(0.62), Inches(4.88), Inches(6.0), Inches(0.3), sz=12, bold=True, col=RED)
s.shapes.add_picture(CHART_RANGE, Inches(0.62), Inches(5.18), width=Inches(11.0))
...
rows = [
    ("院の規模", "月の削減額", "成果報酬(40%×6ヶ月)", "院に残る効果（1年目）"),
    ("医師1・事務2", "約16万円", "6.4万円/月", "約124万円"),
    ("医師1・事務3（標準）", "約24万円", "9.6万円/月", "約200万円"),
    ("医師2・事務5", "約40万円", "16万円/月", "約354万円"),
]
light_table(s, rows, Inches(0.55), Inches(1.85), Inches(7.3), Inches(2.5),
            [Inches(2.3), Inches(1.5), Inches(1.8), Inches(1.7)], hi_col=3, sz=12.5, header_sz=11)
# 右：削減時間の内訳グラフ
bx(s, Inches(8.1), Inches(1.85), Inches(4.7), Inches(3.45), CARD, line=CARDLN, lw=1.0)
bx(s, Inches(8.1), Inches(1.85), Inches(4.7), Inches(0.06), RED)
s.shapes.add_picture(CHART_BREAK, Inches(8.3), Inches(2.05), width=Inches(4.3))
bx(s, Inches(0.55), Inches(5.45), Inches(12.23), Inches(1.5), CARD, line=CARDLN, lw=1.0)
t(s, "標準モデル（医師1・事務3／月83万円・480h・時間単価 約1,729円）：月139h削減 ＝ 月 約24万円", Inches(0.8), Inches(5.56), Inches(11.8), Inches(0.35), sz=12, bold=True, col=RED)
t(s, "1〜6ヶ月＝成果報酬40%を引いて 月14.4万円 が院に → 7ヶ月目以降＝月5万円の保守だけで 月19万円 が院に → 1年目合計 約200万円", Inches(0.8), Inches(5.96), Inches(11.8), Inches(0.4), sz=12.5, bold=True, col=REDD)
t(s, "※「うちは事務3人だから…年200万か」と、その場で自院に当てはめられます。", Inches(0.8), Inches(6.4), Inches(11.8), Inches(0.35), sz=10.5, col=GRY)

# ════════ SLIDE 6.5 — 使うほど院に残る（新料金グラフ）════════
s = sl(); ft(s)
hdr(s, "SIMULATION", "使うほど、院にお金が残る ── 12ヶ月の推移",
    "成果報酬は最初の6ヶ月だけ。7ヶ月目からは月5万円の保守のみ（標準モデル：月24万円削減）")
s.shapes.add_picture(CHART_SAVINGS, Inches(0.45), Inches(1.8), width=Inches(8.4))
RX, RW = Inches(9.1), Inches(3.75)
bx(s, RX, Inches(1.85), RW, Inches(2.45), WHT, line=CARDLN, lw=1.0)
bx(s, RX, Inches(1.85), RW, Inches(0.06), RED)
t(s, "料金（リスクゼロ）", RX+Inches(0.2), Inches(2.0), RW-Inches(0.4), Inches(0.3), sz=13, bold=True, col=RED)
_price = [("初期費用", "0円"), ("月額基本料", "0円"), ("成果報酬", "削減額の40%"),
          ("成果報酬の期間", "6ヶ月"), ("7ヶ月目以降", "月5万円 保守"), ("保守に含む", "月1回MTG・運用相談")]
for _i, (_k, _v) in enumerate(_price):
    _yy = Inches(2.38) + Inches(0.31) * _i
    t(s, _k, RX+Inches(0.2), _yy, Inches(1.7), Inches(0.3), sz=10.5, col=INK)
    t(s, _v, RX+Inches(1.7), _yy, RW-Inches(1.9), Inches(0.3), sz=11, bold=True, col=RED, align=PP_ALIGN.RIGHT)
bx(s, RX, Inches(4.5), RW, Inches(2.15), CARD, line=CARDLN, lw=1.0)
t(s, "御院に残る効果", RX+Inches(0.2), Inches(4.62), RW-Inches(0.4), Inches(0.3), sz=13, bold=True, col=RED)
_eff = [("1〜6ヶ月", "月 14.4万円"), ("7ヶ月目以降", "月 19万円"), ("12ヶ月 累計", "約 200万円")]
for _i, (_k, _v) in enumerate(_eff):
    _yy = Inches(5.0) + Inches(0.37) * _i
    t(s, _k, RX+Inches(0.2), _yy, Inches(1.6), Inches(0.34), sz=10.5, bold=True, col=INK)
    t(s, _v, RX+Inches(1.6), _yy, RW-Inches(1.8), Inches(0.34), sz=12.5, bold=True, col=REDD, align=PP_ALIGN.RIGHT)
t(s, "成果報酬は6ヶ月で卒業。以降は効果まるごと院に。", RX+Inches(0.2), Inches(6.2), RW-Inches(0.4), Inches(0.4), sz=9.5, col=GRY)
...
rows = [
    ...
    ("報酬体系", "削減額の40%（最初の6ヶ月だけ）", "稼働問わず固定課金", "固定保守料"),
    ("7ヶ月目以降", "月5万円の保守のみ（月1MTG込）", "高額保守が続く", "固定保守料が続く"),
...
steps = [
    ...
    ("STEP 3", "手元に利益が残る", "リスクは私たちが取る", "【例：月24万円分を削減】\n削減額24万 × 40% ＝ お支払い 9.6万円", ("貴院に残る効果", "月 14.4万円", "7ヶ月目〜は月19万円（1年目 約200万円）／効果0なら支払い0円")),
]
...
t(s, "✓ 成果報酬は6ヶ月で卒業（以降は月5万の保守のみ・月1MTG込）　✓ IT導入補助金サポート　✓ ロックインなし　✓ 3ヶ月伴走", Inches(0.85), band_y+Inches(0.54), Inches(11.6), Inches(0.35), sz=11.5, bold=True, col=INK)
...
import shutil
prs.save("clinic_dx_v9.pptx")
_dst = "/Users/kikuchikenta/Library/CloudStorage/GoogleDrive-ec-seller@kikuchi-hd.net/マイドライブ/260526_AI医療コンサル/clinic_dx_v9.pptx"
shutil.copy("clinic_dx_v9.pptx", _dst)
print("saved clinic_dx_v9.pptx  /  slides:", len(prs.slides._sldIdLst))
